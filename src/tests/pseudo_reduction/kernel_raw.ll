...
define dso_local void @pseudo_reduction(ptr noalias noundef %A, ptr noalias noundef %T, i32 noundef %N) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %conv = fpext fast float %4 to double
  %arrayidx1 = getelementptr inbounds [1 x double], ptr %S, i64 0, i64 0
